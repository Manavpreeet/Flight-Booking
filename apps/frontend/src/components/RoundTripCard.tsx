// components/RoundTripBookingCard.tsx
"use client";
...
// Shared card for each flight leg
...
// Round trip card
export default function RoundTripBookingCard({
    bookingId,
    tripType,
    passengerCount,
    status,
    ...
    return (
        ...
        >
            <div className="flex justify-between items-center">
                <h2 className="text-lg font-bold">Round Trip Booking</h2>
